...
def test_model():
    ...
    test_features, test_labels = pickle.load(open(
        'preprocess_test.p', mode='rb'))
    ...
    with tf.Session(graph=loaded_graph) as sess:
        ...
        for test_feature_batch, test_label_batch in\
            fruit_fly_cnn.make_batches(test_features, test_labels, batch_size):
